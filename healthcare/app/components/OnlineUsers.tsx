    ...
    useEffect(() => {
        const fetchOnlineUsers = async () => {
            try {
                ...
                setError(err.response?.data?.error || err.message || 'Failed to fetch online users');
                setLoading(false);
            }
        };
        ...
        return (
            <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="text-red-500 p-4 bg-red-50 rounded-lg">
                    ...
                    <p>{error}</p>
                    <p className="mt-2 text-sm">Please make sure you are logged in and have admin privileges.</p>
                </div>
            </div>
        );
    }
