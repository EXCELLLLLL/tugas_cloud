export const menuData = [
    {
        ...
        items: [
            [
                ...
                { text: "Locations", href: "#" },
                { text: "Clinical Trials", href: "#" },
            ],
            [
                { text: "Connect to Support Groups", href: "#" },
                { text: "Patient & Visitor Guide", href: "#" },
                { text: "Billing & Insurance", href: "#" },
                { text: "Departments & Centers", href: "#" },
    ...
    },
    {
        ...
        items: [
            [
                { text: "Diseases & Conditions", href: "#" },
                { text: "Symptoms", href: "#" },
                { text: "Tests & Procedures", href: "#" },
            ],
            [
    ...
    },
    {
        ...
        items: [
            [
                { text: "Medical Professional Resources", href: "#" },
                { text: "Refer a Patient", href: "#" },
                { text: "Continuing Medical Education", href: "#" },
    ...
    },
    {
        ...
        items: [
            [
                ...
                { text: "Centers & Programs", href: "#" },
                { text: "Departments & Divisions", href: "#" },
                { text: "Clinical Trials", href: "#" },
