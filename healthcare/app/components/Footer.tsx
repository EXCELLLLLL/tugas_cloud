        ...
        <>
            ...
            <section className="bg-red-600 text-white py-6">
                <div className="max-w-screen-xl mx-auto px-4 text-center">
                    <h2 className="text-2xl font-bold mb-2">Emergency? Call 911</h2>
                    <p className="text-white/90">For medical emergencies, please call 911 or visit your nearest emergency room.</p>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-gray-400 text-sm">
                                Providing quality healthcare services and innovative medical solutions for a healthier tomorrow.
                            </p>
                            <div className="flex space-x-4">
                                ...
                                <a href="https://www.instagram.com/ciptahospital_indonesia?igsh=dmhwbW54Nm5vcGto" className="text-gray-400 hover:text-white transition">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-gray-400">
                                <li><Link href="/services/primary-care" className="hover:text-white transition">Primary Care</Link></li>
                                <li><Link href="/services/specialists" className="hover:text-white transition">Specialists</Link></li>
                                <li><Link href="/services/emergency" className="hover:text-white transition">Emergency Care</Link></li>
                                <li><Link href="/services/laboratory" className="hover:text-white transition">Laboratory Services</Link></li>
                                <li><Link href="/services/pharmacy" className="hover:text-white transition">Pharmacy</Link></li>
                            </ul>
                        </div>
